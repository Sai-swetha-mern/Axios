...
function File() {
  ...
  const userList = users.map((user, index) => (
    <tr key={index} className='td-style'>
      ...
      <td className='th-td-style'>{user.username}</td>
  ...
  return (
    <div className='container'>
      <h4 style={{ textAlign: 'center', marginBottom: '20px' }}>AXIOS-CURD</h4>
        ...
        <table className='table-style'>
          <thead>
            ...
            <tr>
              ...
              <th className='th-td-style th-style'>EMAIL-ID</th>
              <th className='th-td-style th-style'>USERNAME</th>
